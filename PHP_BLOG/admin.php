...
<?php
 ...
 if (isset($_POST['submit']))
 {
     ...
     $getIns = $blog->insertPost($text,$description,$cat);
 }
?>
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="list-group">
                <a href="admin.php" class="list-group-item active">ADD POST</a>
        ...
        <div class="col-md-8">
            <form action="" method="post">
                <div class="form-group">
                    <input type="text" name="text" class="form-control" placeholder="Enter Title Name">
                </div>
