		...
		<div class="panel-body">
            ...
            <?php
                ...
                if($_SERVER['REQUEST_METHOD'] == "POST")
                {
                    ...
                    if (empty($_FILES['r_image'])) 
                    {
                        ...
                        $upload_file = "images/";
                        $r_image = $upload_file.$_FILES['r_image']['name'];
                    ...
                    if($errValue == 0)
                    {
                        $insertData = $ad->updateRoom($id,$r_name,$r_bed_no,$r_capacity,$r_price,$r_image,$r_number);
                    }
			...
			<div class="col-sm-9">
				...
				<form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <input type="submit" value="UPDATE ROOM" class="btn btn-info">
                    </div>
                </form>
			</div>
